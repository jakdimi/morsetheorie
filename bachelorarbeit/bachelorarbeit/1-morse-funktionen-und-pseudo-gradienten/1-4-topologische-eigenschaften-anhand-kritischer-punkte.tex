...
Diffeomorphismus $\varphi$ \say{nach unten zu ziehen}, bis $\varphi(f^{-1}(b)) = f^{-1}(a)$.
...
\begin{proof}
    ...
    \begin{figure}[H]
        \centering
        \subfloat{
            \includegraphics[width=0.4\linewidth]{../resources/Me-Diagram5-sublevelsets-of-f-and-F.jpeg}
        } \\
        \subfloat{
            \begin{tikzpicture}
                ...
                \node [
                    above right,
                    inner sep=0] (image) at (0,0) {\includegraphics[width=0.4\textwidth]{../resources/subniveaumengen-parametrisiert.jpeg}};
